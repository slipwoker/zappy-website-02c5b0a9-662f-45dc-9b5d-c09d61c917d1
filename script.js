document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, rule) {
      const label = field.closest('[data-field], .form-group, .field-wrapper');
      const labelText = label
        ? (label.querySelector('label') || {}).textContent || 'This field'
        : 'This field';

      const messages = {
        required: labelText.trim() + ' is required.',
    ...
    function clearFieldError(field) {
      const wrapper = field.closest('[data-field], .form-group, .field-wrapper') || field.parentElement;
    ...
    contactForm.addEventListener('input', function (e) {
      const field = e.target;
      if (field.matches('input, textarea, select') && field.classList.contains(FIELD_ERROR_CLASS)) {
        validateField(field);
      }
    });
  ...
  const OBSERVE_SELECTOR = '.animate-on-scroll, [data-animate], .fade-in, .slide-up, .slide-in';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '02c5b0a9-662f-45dc-9b5d-c09d61c917d1',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '02c5b0a9-662f-45dc-9b5d-c09d61c917d1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '02c5b0a9-662f-45dc-9b5d-c09d61c917d1';
